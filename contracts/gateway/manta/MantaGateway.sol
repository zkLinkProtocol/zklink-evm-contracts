...
abstract contract MantaGateway is BaseGateway, IMantaGateway {
    /// @notice Manta message service on local chain
    IMantaMessenger public immutable MESSAGE_SERVICE;
    ...
    constructor(IMantaMessenger _messageService) {
        MESSAGE_SERVICE = _messageService;
    }

    function __MantaGateway_init() internal onlyInitializing {
        __BaseGateway_init();
    }
}
