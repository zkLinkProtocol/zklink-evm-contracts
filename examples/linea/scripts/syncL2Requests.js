...
task('syncL2Requests', 'Send sync point to arbitrator')
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const minimumFee = await lineaL2Contract.getContract("0xC499a572640B64eA1C8c194c43Bc3E19940719dC", lineaL2Contract.signer).minimumFeeInWei();
        ...
        while (true) {
            ...
            if (messageStatus === OnChainMessageStatus.CLAIMABLE) {
                ...
                const tx = await lineaL1Gateway.claimMessage(message.value.toNumber(), executeCalldata, message.messageNonce.toNumber());
                console.log(`The tx hash: ${tx.hash}`);
