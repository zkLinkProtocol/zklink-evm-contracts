    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const adapterParams =
            hre.ethers.utils.defaultAbiCoder.encode(
                ['uint256'],
                [finalizeMessageGasLimit],
            )
        let tx = await arbitrator.forwardMessage(scrollL1GatewayAddr, 0, callData, adapterParams, { gasLimit: 1000000, value: hre.ethers.utils.parseEther('0.001') });
        await tx.wait();
